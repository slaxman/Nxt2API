...
public class Utils {
    ...
    /**
     * Convert a decimal value to a decimal string.  The decimal value scale
    ...
    /**
     * Convert a string to a Nxt object identifier
     *
    ...
    /**
     * Convert a full hash to a Nxt object identifier
     *
    ...
    /**
     * Get the Reed-Solomon string for an account identifier.  The
     * returned string will be prefixed with 'Nxt-'.
     *
     ...
     * The string must begin with 'NXT-'.
     *
    ...
    /**
     * Convert a Nxt object identifier to a string
     *
     ...
     */
    public static String formatJSON(Response response) {
        return formatJSON(response.getObjectMap());
    }
